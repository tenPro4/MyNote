    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "CREATE TRIGGER IF NOT EXISTS _t1_dn BEFORE DELETE ON " + TABLE_NOTES + " BEGIN " +
                        ...
                        "(" + COLUMN_ID + "," + COLUMN_PARENT_ID + "," + COLUMN_TITLE + ","
                        + COLUMN_BODY + "," + COLUMN_TYPE + "," + COLUMN_ARCHIVED + ","
                        + COLUMN_THEME + "," + COLUMN_COUNTER + "," + COLUMN_DATE + ","
                        + COLUMN_EXTRA + ")" +
                        "VALUES('||old." + COLUMN_ID + "||','||old." + COLUMN_PARENT_ID + "||','||quote(old."
                        + COLUMN_TITLE + ")||','||quote(old." + COLUMN_BODY + ")||','||old." + COLUMN_TYPE
                        + "||','||old." + COLUMN_ARCHIVED + "||','||old." + COLUMN_THEME + "||','||old."
                        + COLUMN_COUNTER + "||','||quote(old." + COLUMN_DATE + ")||','||quote(old." + COLUMN_EXTRA
                        + ")||')'); END"
        );
    }
