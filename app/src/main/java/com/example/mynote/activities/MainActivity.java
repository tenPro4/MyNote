...
import com.example.mynote.adapters.DrawerAdapter;
import com.example.mynote.database.Controller;
import com.example.mynote.dialogs.ImportDialog;
import com.example.mynote.dialogs.SaveDialog;
import com.example.mynote.fragments.MainFragment;
...
import com.example.mynote.models.Drawer;
...
public class MainActivity extends AppCompatActivity implements RecyclerFragment.Callbacks {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_date_sorting){
            if(App.sortCategoriesBy == Controller.SORT_DATE_ASC) App.instance.putPrefs(App.SORT_CATEGORIES_KEY, Controller.SORT_DATE_DESC);
            else App.instance.putPrefs(App.SORT_CATEGORIES_KEY, Controller.SORT_DATE_ASC);
            App.instance.categorySorting();
            fragment.reloadItem();
            return true;
        }else if(id == R.id.action_title_sorting){
            if(App.sortCategoriesBy == Controller.SORT_TITLE_ASC) App.instance.putPrefs(App.SORT_CATEGORIES_KEY, Controller.SORT_TITLE_DESC);
            else App.instance.putPrefs(App.SORT_CATEGORIES_KEY, Controller.SORT_TITLE_ASC);
            App.instance.categorySorting();
            fragment.reloadItem();
            return true;
        }
